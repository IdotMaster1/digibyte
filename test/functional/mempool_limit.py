...
class MempoolLimitTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(node.getmempoolinfo()['minrelaytxfee'], Decimal('0.10000000'))
        assert_equal(node.getmempoolinfo()['mempoolminfee'], Decimal('0.10000000'))
        ...
        assert_equal(node.getmempoolinfo()['minrelaytxfee'], Decimal('0.10000000'))
        assert_greater_than(node.getmempoolinfo()['mempoolminfee'], Decimal('0.10000000'))
